...
{
    /// <summary>Represents a 4 row by 1 column Matrix.</summary>
    public struct Matrix4x1
    {
        /// <summary>Represents the value at Row 1 Column 1 of the matrix.</summary>
        public float M11;
        /// <summary>Represents the value at Row 2 Column 1 of the matrix.</summary>
        public float M21;
        /// <summary>Represents the value at Row 3 Column 1 of the matrix.</summary>
        public float M31;
        /// <summary>Represents the value at Row 4 Column 1 of the matrix.</summary>
        public float M41;
