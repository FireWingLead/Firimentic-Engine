...
namespace FirimenticEngine.Graphics.Shaders
{
    ...
    public abstract class ShaderProgram : IDisposable {
        ...
        public void Link() {
            ...
            GL.GetProgram(Handle, GetProgramParameterName.ActiveAttributes, out int numAttrs);
            ...
            GL.GetProgram(Handle, GetProgramParameterName.ActiveUniforms, out numAttrs);
